...
public class InfrastructureApp {
    public static void main(final String[] args) {
        ...
        new LeetSyncApiStack(app, "LeetSyncApiStack", dataStack.getAcSubmissionsTable(), dataStack.getUsersTable(), dataStack.getUserStatsCacheTable(), dataStack.getRecommendationsCacheTable());
        ...
        new LeetSyncRecommendationStack(app, "LeetSyncRecommendationStack", dataStack.getUserStatsCacheTable(), dataStack.getRecommendationsCacheTable());
